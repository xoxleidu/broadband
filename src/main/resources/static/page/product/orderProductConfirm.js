layui.use(['form','layer','table','laytpl'],function(){
    ...
    if(productId == null && productId == undefined && productId == ""){
        parent.$("#productId").val(1);
    }*/

    //alert(parent.$("#sysIdcard").val())
    ...
    $.ajax({
        ...
        success: function(res){
            ...
            for(var i=0; i<res.result.records.length; i++) {
                var opt="<option value='" + res.result.records[i].id + "'";
                opt += ">" + res.result.records[i].communityName + "</option>"; //动态添加数据
    ...
    $.ajax({
        ...
        data: JSON.stringify($("#equipmentIds").val().split(",")),
        contentType: "application/json;charset=utf-8",
        dataType: "json",
        success: function(res){
            //用户列表
    ...
    $.ajax({
        ...
        data: JSON.stringify($("#giftIds").val().split(",")),
        contentType: "application/json;charset=utf-8",
        dataType: "json",
        success: function(res){
            //用户列表
